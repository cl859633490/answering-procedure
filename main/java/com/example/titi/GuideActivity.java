...
public class GuideActivity extends MainActivity {
  ...
  /*  ViewPager vpGuide;
    ...
    private static final int[] pics =
            {R.layout.layout_guide1, R.layout.layout_guide2, R.layout.layout_guide3};
    // 底部小点图片
        ...
        for (int i = 0; i < pics.length; i++) {
            ...
            if (i == btnIndex) {
                view.findViewById(R.id.btn_enter).setOnClickListener(new View.OnClickListener() {
                    private JSONArray SharePreferenceUtil;

                    @Override
                    public void onClick(View v) {
                        // 如果切换到后台，就设置下次不进入功能引导页
                        SharePreferenceUtil.put(GuideActivity.this, ConstantConfig.FIRST_OPEN, true);
                        startActivityFinish(StartActivity.class);
                    }

                    private void startActivityFinish(Class<StartActivity> startActivityClass) {
                    }
                });
            }
        }
